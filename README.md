...
- Fields of Interest:  
  ...
  - AI coding practices ([vybe](https://github.com/iptracej-education/vybe) - spec-driven dev, [multi-agent-coding-loop](https://github.com/iptracej-education/multi-agent-coding-loop)) 
