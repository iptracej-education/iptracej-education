...
- Currently pursuing the [**Master of Science in Analytics (MSA)**](https://github.com/iptracej-education/OMSA) at **Georgia Tech (Class of 2026)**.
  ...
  - [Vulnerability Representation Layers Project](https://github.com/iptracej-education/vuln-signal-layers) with Logistic Regression, XGBoost, MLP, and Transformer
  - [VulnSignal] 
