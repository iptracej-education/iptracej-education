...
- Currently pursuing the [**Master of Science in Analytics (MSA)**](https://github.com/iptracej-education/OMSA) at **Georgia Tech (Class of 2026)**.
  ...
  - <img src="https://upload.wikimedia.org/wikipedia/commons/8/84/Georgia_Tech_logo_2021_Cropped.png" width="16" height="16">  [Patch-Delta-Guided Representation Layers Research](https://github.com/iptracej-education/vuln-representation-layers) [(pdf)](https://github.com/iptracej-education/vuln-representation-layers/blob/main/Report.pdf) with Logistic Regression, XGBoost, MLP, and Transformer
